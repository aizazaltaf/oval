...
void main() {
  ...
  group('UnwantedVisitorGuide Widget Tests', () {
    testWidgets('should build without errors', (tester) async {
      await tester.pumpWidget(
        _buildTestWidget(
          Builder(
            builder: (context) => UnwantedVisitorGuide(
      ...
      expect(find.byType(UnwantedVisitorGuide), findsOneWidget);
    });
    ...
    testWidgets('displays OK button', (tester) async {
      ...
      await tester.pumpAndSettle();
      final context = tester.element(find.byType(UnwantedVisitorGuide));
    ...
    testWidgets('displays guide title and description', (tester) async {
      ...
      final context = tester.element(find.byType(UnwantedVisitorGuide));
      final localizations = AppLocalizations.of(context)!;
      expect(find.text(localizations.history_unwanted_title), findsOneWidget);
      expect(find.text(localizations.history_unwanted_desc), findsOneWidget);
    });
