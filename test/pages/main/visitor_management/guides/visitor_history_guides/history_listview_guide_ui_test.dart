...
void main() {
  ...
  group('HistoryListviewGuide Widget Tests', () {
    testWidgets('should build without errors', (tester) async {
      await tester.pumpWidget(
        _buildTestWidget(
          Builder(
            builder: (context) => HistoryListviewGuide(
      ...
      expect(find.byType(HistoryListviewGuide), findsOneWidget);
    });
    ...
    testWidgets('displays OK button', (tester) async {
      ...
      await tester.pumpAndSettle();
      final context = tester.element(find.byType(HistoryListviewGuide));
    ...
    testWidgets('displays guide title and description', (tester) async {
      ...
      final context = tester.element(find.byType(HistoryListviewGuide));
      final localizations = AppLocalizations.of(context)!;
      expect(find.text(localizations.history_list_guide_title), findsOneWidget);
      expect(find.text(localizations.history_list_guide_desc), findsOneWidget);
    });
