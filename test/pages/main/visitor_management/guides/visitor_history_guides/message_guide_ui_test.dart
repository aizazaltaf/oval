...
void main() {
  ...
  group('MessageGuide Widget Tests', () {
    testWidgets('should build without errors', (tester) async {
      await tester.pumpWidget(
        _buildTestWidget(
          Builder(
            builder: (context) => MessageGuide(
      ...
      expect(find.byType(MessageGuide), findsOneWidget);
    });
    ...
    testWidgets('displays OK button', (tester) async {
      ...
      await tester.pumpAndSettle();
      final context = tester.element(find.byType(MessageGuide));
    ...
    testWidgets('displays guide title and description', (tester) async {
      ...
      final context = tester.element(find.byType(MessageGuide));
      final localizations = AppLocalizations.of(context)!;
      expect(find.text(localizations.history_message_title), findsOneWidget);
      expect(find.text(localizations.history_message_desc), findsOneWidget);
    });

    testWidgets('OK button triggers skip logic', (tester) async {
      await tester.pumpWidget(
        _buildTestWidget(
          Builder(
            builder: (context) => MessageGuide(
    ...
    testWidgets('Back button triggers updateCurrentGuideKey', (tester) async {
      ...
      verify(
        () => visitorManagementBlocHelper.mockVisitorManagementBloc
            .updateCurrentGuideKey("history_neighbourhood"),
      ).called(1);
    });
