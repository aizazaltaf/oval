...
void main() {
  group('ChatGuide UI Tests', () {
    ...
    testWidgets('should build without errors', (tester) async {
      ...
      expect(find.byType(ChatGuide), findsOneWidget);
    });
    ...
    testWidgets('renders all UI elements', (tester) async {
      ...
      expect(
        find.byWidgetPredicate(
          (w) => w is Text && w.data == 'Tap the chat option to send messages.',
        ),
        findsOneWidget,
      );
    ...
    testWidgets('pressing Back calls updateCurrentGuideKey("video")',
        (tester) async {
      await tester.pumpWidget(createTestWidgetWithContext());
      await tester.pumpAndSettle();
    ...
    testWidgets('displays correct button labels', (tester) async {
      ...
      final context = tester.element(find.byType(ChatGuide));
    ...
    testWidgets('displays correct guide title and description', (tester) async {
      ...
      // Check description
      expect(
        find.text(localizations.chat_guide_desc),
        findsOneWidget,
      );
    });
