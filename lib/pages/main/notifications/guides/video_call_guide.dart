...
class VideoCallGuide extends StatelessWidget {
  const VideoCallGuide({
    super.key,
        ...
        children: [
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  CustomGradientButton(
                    onSubmit: () => bloc.updateCurrentGuideKey("chat"),
              ...
              SizedBox(
                ...
                child: CommonFunctions.guideDescription(
                  innerContext.appLocalizations.video_call_guide_desc,
                ),
              ),
            ],
          ),
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                TextButton(
                  onPressed: () => bloc.updateCurrentGuideKey("audio"),
                  child: Text(
