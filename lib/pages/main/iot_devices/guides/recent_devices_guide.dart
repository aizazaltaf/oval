...
class RecentDevicesGuide extends StatelessWidget {
  const RecentDevicesGuide({
    super.key,
            ...
            Column(
              ...
              children: [
                ...
                CommonFunctions.guideTitle(
                  innerContext.appLocalizations.recent_devices_guide_title,
                ),
                const SizedBox(height: 5),
                SizedBox(
                  width: 70.w,
                  child: CommonFunctions.guideDescription(
                    innerContext.appLocalizations.recent_devices_guide_desc,
                  ),
                ),
              ],
            ),
